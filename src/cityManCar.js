...
// Speed for car movement
const carMoveSpeed = 0.05; // Adjust the speed as needed

// Store car reference
let car = null;

// Function to move the car towards you (along the z-axis)
const moveCar = () => {
  if (car) {
    car.position.z += carMoveSpeed; // Move car along the z-axis

    // Optional: Reset the car's position when it moves too far
    if (car.position.z > sizes.height / 2) {
      car.position.z = -sizes.height / 2;
    }
  }
};
